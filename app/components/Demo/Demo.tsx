...
export default function Demo({ className }: DemoProps) {
  return (
    <Grid className={className}>
      ...
      <div className="col-span-full hidden w-full items-center justify-center md:col-span-10 md:col-start-2 md:flex md:justify-between xl:col-span-8 xl:col-start-3">
      ...
      <div className="col-span-full flex w-full items-center justify-center md:hidden">
        <iframe
          title={"bandcamp"}
          src="https://bandcamp.com/EmbeddedPlayer/album=591127691/size=large/bgcol=333333/linkcol=ffffff/tracklist=false/transparent=true/"
          seamless
          className="h-[419px] w-[300px] border-0"
        />
      </div>
    </Grid>
  )
